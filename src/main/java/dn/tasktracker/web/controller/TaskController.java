...
public class TaskController {
    ...
    private static final String GET_TASK_BY_TITLE = "/api/v1/tasks/task/";
    private static final String CREATE_TASK = "/api/v1/tasks/task/create";
    private static final String DELETE_TASK = "/api/v1/tasks/task/delete/{id}";
    private static final String UPDATE_TASK_STATUS = "/api/v1/tasks/task/update/status/{id}";
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Cписок задач получен"),
            @ApiResponse(responseCode = "404",description = "Задачи не найдены"),
            @ApiResponse(responseCode = "500",description = "Неизвестная ошибка сервера")
    })
